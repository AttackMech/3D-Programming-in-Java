...
*   object.
*   
*   Notes: This stage is the same as before with an added ball object.
*   
*   This program is based on Stage6 of this project.
*   
*   
*   TEST PLAN
*
...
*       
*   1) No touching edges:
*       As in the previoius stage, all objects do not quite touch each other when coming into contact.  This is because the collision
*       detection merely stops motion when a collision is detected.  The move increments of the ball may not allow it to come into
*       perfect contact with the character or obstacle.
*       
*   2) Ball creation:
*       The ball is created to be smaller than the character and placed at an initial starting position of (x, z) = (1, 1.8).  This
*       placement does not detect if there is currently an obstacle or character occupying that postion.  Since I am creating this
*       scene by hand, there is no reason to automatically check.  The ball size and position can be changed if necessary, by modifying
*       the initial values within the Ball class.
*
*/ 
