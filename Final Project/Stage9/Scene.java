...
*   
*   Notes: This stage is the same as before with added jumping animation for the character object.
*   
*   This program is based on Stage8 of this project.
*   
*   
*   TEST PLAN
*
...
*       Once the jump is initiated, the character x/z position is locked, as well as the rotation.  The character does not respond to
*       any key press until the animation is finished.
*
*/ 
