...
*   the ball always moves away from the character and stops at obstacles.  Additionally, the ball now rotates based on the direction of
*   movement.
*
*/
...
public class Ball
{
    ...
    private static final double rotAmt =  Math.PI / 5;
    ...
    // resets the rotation value for a new movement
    public void resetRot() {
        rotValue = 0;
    }  // end of method resetRot()
